A data analysis and machine-learning toolset using pandas DataFrame and
scikit-learn models.
...
-  MLtools: machine learning tools, main toolset
   ...
   -  Machine learning model training, weight analysis, validation and
      prediction
   -  Cross-validation
...
-  SNPtools: used for genetic SNP data, not general
   ...
   -  `PLINK <https://www.cog-genomics.org/plink2>`__ binary data
      reading
